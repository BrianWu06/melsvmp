...
This is a basic example showing how to use the function mels_vmp to fit a MELS model by an example. We use a simple longitudinal dataset "riesby" to illustrate the usage, you can import and view the description of this dataset by 
```{r}
library(melsvmp)
